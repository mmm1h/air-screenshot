...
- The five destinations, light/dark modes, 820 × 640 scaling, toolbar drag/visibility, clipboard-pin shortcut, tray visibility, inline shortcut errors, and the three application-icon choices are visually exercised in the native window.
